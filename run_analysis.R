# Read the metadata for features and activitires.
...
#Combine the respective datas from training and test datas
subject <- rbind(subjectTrain, subjectTest)
activity <- rbind(activityTrain, activityTest)
features <- rbind(featuresTrain, featuresTest)

#name the columns of "features" using metadata in featureNames
colnames(features) <- t(featureNames[2])

# final merge data with column names for activity and subject
...
#names of the variables in extractedData after above edits
